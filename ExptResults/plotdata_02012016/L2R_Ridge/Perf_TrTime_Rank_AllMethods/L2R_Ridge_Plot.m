...
Randbin = importdata('RandBin_OneVsAll_covtype-mult_Perf.plotdata', ' ', 1);
Fourier = importdata('FOURIER_OneVsAll_Laplace_covtype-mult_Perf.plotdata', ' ', 1);
Nystrom = importdata('NYSTROM_OneVsAll_Laplace_covtype-mult_Perf.plotdata', ' ', 1);
Blockdiag = importdata('BLOCKDIAG_OneVsAll_Laplace_covtype-mult_Perf.plotdata', ' ', 1);
% Standard = importdata('STANDARD_OneVsAll_Laplace_covtype-mult_Perf.plotdata', ' ', 1);
...
title('covtype-mult: Test Accuracy VS R')
legend('RandBin', 'Fourier', 'Nystrom', 'BlockDiag', 'Location','SouthEast');
% legend('RandBin', 'Fourier', 'Nystrom', 'BlockDiag', 'Kernel', 'Location','SouthEast');
saveas(h1,'covtype-mult_L2R_Ridge_Accu_R','fig');
saveas(h1,'covtype-mult_L2R_Ridge_Accu_R','pdf');
...
title('covtype-mult: Train Time VS R')
legend('RandBin', 'Fourier', 'Nystrom', 'BlockDiag', 'Location','SouthEast');
% legend('RandBin', 'Fourier', 'Nystrom', 'BlockDiag','Kernel', 'Location','SouthEast');
saveas(h2,'covtype-mult_L2R_Ridge_Traintime_R','fig');
saveas(h2,'covtype-mult_L2R_Ridge_Traintime_R','pdf');
